...
import com.team3.realestatemanager.adapters.PlacesAdapter
import com.team3.realestatemanager.firebase.FireStoreClass
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSharedPreferences =
            this.getSharedPreferences(Constants.REALESTATE_PREFERENCES, Context.MODE_PRIVATE)
     ...
     */
    fun populateBoardsListToUI(boardsList: ArrayList<Place>) {
        ...
        if (boardsList.size > 0) {
            ...
            rv_places_list.layoutManager = LinearLayoutManager(this@MainActivity)
            rv_places_list.setHasFixedSize(true)

            // Create an instance of BoardItemsAdapter and pass the boardList to it.
            val adapter = PlacesAdapter(this@MainActivity, boardsList)
            rv_places_list.adapter = adapter // Attach the adapter to the recyclerView.
